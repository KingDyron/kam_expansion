...
type
  ...
  TSEEditorForm = class(TForm)
    ...
    procedure ProposalTypeChange(Sender : TObject);
  strict private
    fEditor:               TSEEditor;
    fSynEdit:              TSynEdit;
...
{$ENDIF}
  ...
  fSynCompletion.OnTypeChange := ProposalTypeChange;
...
procedure TSEEditorForm.ProposalTypeChange(Sender : TObject);
begin
  fSynCompletion.ItemList.Clear;
  fSynCompletion.InsertList.Clear;
  if ptActions in fSynCompletion.ProposalTypes then
  begin
  ...
  if ptStates in fSynCompletion.ProposalTypes then
  begin
  ...
  if ptUtils in fSynCompletion.ProposalTypes then
  begin
  ...
  if ptLocal in fSynCompletion.ProposalTypes then
  begin
  ...
  if ptEvents in fSynCompletion.ProposalTypes then
  begin
