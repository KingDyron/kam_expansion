...
type
  ...
  public
    ...
    EquipRateLeather, EquipRateIron, EquipRateTH: Word; //Number of ticks between soldiers being equipped. Separated into Leather/Iron to keep KaM compatibility.
...
begin
  ...
  EquipRateTH := 500; //Measured in KaM: AI equips 1 iron soldier every ~50 seconds
