    ...
    begin
      ...
      if GroupReq[gtMachines] > 0 then
        ...
        begin
          ...
          if gHands[fOwner].Locks.GetUnitBlocked(UT2) <> ulUnlocked then
            Continue;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if gHands[fOwner].Locks.GetUnitBlocked(UT) <> ulUnlocked then
          Continue;
