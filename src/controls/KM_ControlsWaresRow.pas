...
type
  ...
  TKMCostsRowMultiCol = class(TKMControl)
  private
    fItems : array of record
      X, Y, Wdt : Integer;
      DownColor : Cardinal;
  ...
  public
    ...
    property WarePlan : TKMWarePlan read fWarePlan write SetWareplan;
    property ItemHeight : Byte read fItemHeight write SetItemHeight;
    procedure SetColor(aIndex : Integer; aColor : Cardinal);
  end;
...
constructor TKMCostsRowMultiCol.Create(aParent: TKMPanel; aLeft: Integer; aTop: Integer; aWidth: Integer; aHeight: Integer; aMaxCount: Byte = 4);
begin
  Inherited Create(aParent, aLeft, aTop, aWidth, aHeight);
  MaxInRow := aMaxCount;
  fWarePlan.Reset;
...
procedure TKMCostsRowMultiCol.RefreshItems;
var I, J, K, lTop, wareWidth, inRowCnt, rowsCnt : Integer;
begin
  J := fWarePlan.Count;
  SetLength(fItems, fWarePlan.Count);
...
procedure TKMCostsRowMultiCol.SetWareplan(aPlan : TKMWarePlan);
begin
  fWarePlan.CopyFrom(aPlan);
  RefreshItems;
end;

procedure TKMCostsRowMultiCol.SetItemHeight(aHeight : Byte);
begin
  fItemheight := aHeight;
  RefreshItems;
end;

procedure TKMCostsRowMultiCol.SetColor(aIndex: Integer; aColor: Cardinal);
begin
  fItems[aIndex].DownColor := aColor;
end;

procedure TKMCostsRowMultiCol.MouseOver(X: Integer; Y: Integer; Shift: TShiftState);
var I, J : Integer;
begin
  Inherited;
  J := WarePlan.Count;
...
procedure TKMCostsRowMultiCol.Paint;
var I, J, id : Integer;
begin
