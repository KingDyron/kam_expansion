...
const
  ProjectileLaunchSounds: array[TKMProjectileType] of TSoundFX = (sfxBowShoot, sfxCrossbowShoot, sfxNone, {sfxRockThrow}sfxCatapultShoot, sfxCatapultShoot, sfxBalistaShoot, sfxCrossbowShoot);
  ...
  ProjectileSpeeds: array[TKMProjectileType] of Single = (0.75, 0.8, 0.6, 0.8, 0.5, 1, 1.1);
