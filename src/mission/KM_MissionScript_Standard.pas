                          ...
                          begin
                            ...
                            begin
                              if fLastHouse.HouseType in [htStore, htTownHall, htMarket] then
                                fLastHouse.WareAddToIn(WARE_ID_TO_TYPE[P[0]], qty)
                              else
    ...
    ctBlockUnit:        if fLastHand <> HAND_NONE then
                        begin
                          ...
                          begin
                            ...
                            //else
                            if (P[1] = 1) then
                              gHands[fLastHand].Locks.SetUnitBlocked(ulBlocked, UT)
                            else
                              gHands[fLastHand].Locks.SetUnitBlocked(ulNotVisible, UT)
                          end;
                        end;
...
//          'There can''t be ');
    ...
    begin
      //if (UT = utMilitia) and (gHands[I].Locks.GetUnitBlocked(UT, True) <> ulUnlocked) then
