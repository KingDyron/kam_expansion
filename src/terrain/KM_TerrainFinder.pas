...
type
  ...
  public
    procedure GetTilesWithinDistance(const aStart: TKMPoint; aRadius: Byte; aPass: TKMTerrainPassability; aList: TKMPointList);
  end;
...
function TKMTerrainFinderCommon.FindNearest(const aStart: TKMPoint; aRadius: Byte; aPassability: TKMTerrainPassabilitySet; out aEnd: TKMPoint): Boolean;
begin
  SetLength(fStart, 1);
  fStart[0] := aStart;
  fRadius := aRadius;
