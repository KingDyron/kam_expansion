...
const
  ...
  GUIHouseOrderFull: array [1..59] of TKMHouseType = (
    ...
    htMarket, htMerchant, htStall, htCartographers, htForest,
  ...
  School_Order: array [0..18] of TKMUnitType = (
    utSerf, utBuilder, utStonemason, utWoodcutter, utCarpenter,
    utClayPicker, utFisher, utFarmer, utBaker, utAnimalBreeder, utButcher,
    utMiner, utMetallurgist, utSmith, utOperator, utRecruit, utFeeder, utHouseBuilder, utMountedSerf);
  ...
  Soldiers_Order: array[0..42] of TKMUnitType = (
  ...
  MapEd_Order: array [0..44] of TKMUnitType = (
    utFighter, utMilitia, utAxeFighter, utSwordFighter, utBowman, utCrossbowman,
