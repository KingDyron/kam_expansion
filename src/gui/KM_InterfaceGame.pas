...
const
  ...
  GUIHouseOrderFull: array [1..53] of TKMHouseType = (
    htSchool, htInn, htBarracks, htTownHall,  htStore,
    htSmallStore, htCottage, htHouse, htPalace,//

    htQuarry, htWoodcutters, htSawmill, htPottery, htFarm,
    htWell,//


    htMill, htBakery, htSwine, htButchers, htHovel,
    htVineyard, htAppleTree, htFishermans,  htStables, htTannery,//

    htGoldMine, htIronMine, htBitinMine, htCoalMine,//

    htWeaponWorkshop, htArmorWorkshop, htMetallurgists, htIronSmithy,
    htIronFoundry, htWeaponSmithy, htArmorSmithy, htSiegeWorkshop,htStoneWorkshop,
    htWoodBurner,//

    htWall, htWall2, htWall3, htWall4, htWall5,
    htWallTower, htWatchTower,//
    htStall, htMarket, htMerchant, htCollectors, htTailorsShop,
    htProductionThatch,  htSign
    );
