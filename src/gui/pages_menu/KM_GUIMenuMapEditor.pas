...
begin
  ...
  Panel_MapEd.AnchorsStretch;
    ...
    Panel_MapsFilters.Hitable := false;
      ...
      ColumnBox_Campaigns.SetColumns(fntOutline, ['Campaigns'],
                                             [0]);
      ...
      Button_EditCampaignMap := TKMButton.Create(Panel_MapFilter, - 10,  Image_Campaign.Bottom + 10, Image_Campaign.Width, 25, 'Edit Map', bsGame);
