...
begin
  ...
  FreeAndNil(fGuiGameStructure);
  FreeAndNil(fGuiGameRatios);
  FreeAndNil(fGuiGameStats);
  FreeAndNil(fGuiMenuOptions);
  FreeAndNil(fGuiGameResultsSP);
  FreeAndNil(fGuiGameResultsMP);
  FreeAndNil(fGuiGameCustomPanel);
  FreeAndNil(fGuiGameGuide);
  FreeAndNil(fGuiGameGoals);
  FreeAndNil(fGuiGameWares);
  FreeAndNil(fMessageStack);
  FreeAndNil(fGuiGameMessages);
