...
begin
  ...
  Panel_House.Hitable := false;
    ...
    TKMLabel.Create(Panel_House, 30, 150, 300, 20, gResTexts[1910], fntMetal, taCenter);
    ...
    TKMLabel.Create(Panel_House, 30, 215, 300, 20, gResTexts[1911], fntMetal, taCenter);
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Button_Select[I].Top := 100 + (I div 5) * 40;
        Button_Select[I].Left := 30 + (I mod 5) * 34;
  ...
  begin
    ...
    begin
      ...
      Label_AttackHouse.Caption := gResTexts[1916] + IntToStr(GetHouseDamage);
    ...
    case gRes.Units[UT].GetTrainingHouse of
      htPalace: begin
                  ...
                  for I := 1 to 4 do
                    ...
                    begin
                      if warePlan[I - 1].W <> wtJewerly then
                        warePlan[I - 1].C := warePlan[I - 1].C + (gRes.Units[UT].PalaceCost.PhaseCount - 1);
