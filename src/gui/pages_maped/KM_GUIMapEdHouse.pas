...
var
  I: Integer;
begin
  Panel_House := TKMScrollPanel.Create(aParent, TB_PAD, 45, TB_MAP_ED_WIDTH - TB_PAD + 10, aParent.MasterParent.Height - 350, [saVertical], bsGame, ssCommon);
  ...
  Panel_House.ScrollV_PadLeft := -20;
