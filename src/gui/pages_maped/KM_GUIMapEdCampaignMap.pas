...
begin
  ...
  Panel_Campaign.AnchorsStretch;
    ...
    Panel_Settings := TKMPanel.Create(Panel_Campaign, 10, Panel_Campaign.Height - 500, 214, 400);
      ...
      TKMLabel.Create(Panel_Settings, 10, 10, Panel_Settings.Width - 20, 20, 'Flags count', fntOutline, taLeft);

      Edit_FlagsCount:= TKMNumericEdit.Create(Panel_Settings, 10, 30, 1, 64);
      Edit_FlagsCount.OnChange := Campaign_Click;

      Button_SetFlagColor := TKMButton.Create(Panel_Settings, 10, Panel_Settings.Height - 30 , Panel_Settings.Width - 20, 25, 'Set Flag Color', bsGame);
      Button_SetFlagColor.OnClick := Campaign_Click;

      TKMLabel.Create(Panel_Settings, 10, Button_SetFlagColor.Top - 80, Panel_Settings.Width - 20, 20, 'Unlock after:', fntOutline, taLeft);
      ...
      Radio_TextPos.Add('Left Botton');
      Radio_TextPos.Add('Right Botton');
      Radio_TextPos.OnChange := Campaign_Click;

      TKMLabel.Create(Panel_Settings, 10, Radio_TextPos.Top - 20, Panel_Settings.Width - 20, 20, 'Text Pos', fntOutline, taLeft);

      Edit_NodeCount:= TKMNumericEdit.Create(Panel_Settings, 10, Radio_TextPos.Top - 45, 0, 64);
      Edit_NodeCount.OnChange := Campaign_Click;

      TKMLabel.Create(Panel_Settings, 10, Edit_NodeCount.Top - 20, Panel_Settings.Width - 20, 20, 'Nodes count', fntOutline, taLeft);
