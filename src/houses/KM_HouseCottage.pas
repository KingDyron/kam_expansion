...
type
  ...
  private
    ...
    function AddKid(aFamily, aTick : Cardinal) : byte;
    procedure GrowKid(aIndex : Integer; aTick : Cardinal);
...
function TKMHouseCottage.AddKid(aFamily, aTick : Cardinal) : Byte;
  procedure Add;
  var J : Integer;
  begin
    J := length(fKidTime);
...
procedure TKMHouseCottage.GrowKid(aIndex : Integer; aTick : Cardinal);
  procedure TakeKid;
  var I : Integer;
  begin
