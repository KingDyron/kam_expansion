...
const
  WARRIOR_SFX_FOLDER: array[WARRIOR_MIN..WARRIOR_MAX] of string = (
    ...
    'destroyer', 'bowman', '', '', 'knights', 'axeman', 'machines', 'militia', 'axeman',//destroyer, medic, battle ship, boat, pyro, lekter, mobile wall
    'champion', 'machines','alchemist'
    );
  ...
  CITIZEN_SFX: array[CITIZEN_MIN..CITIZEN_MAX] of record
    ...
    (WarriorVoice: utPikeman;     SelectID:0; DeathID:0),  //utFeeder
    (WarriorVoice: utKnight;     SelectID:0; DeathID:0),  //utBuilder2
    (WarriorVoice: utAxeFighter;     SelectID:0; DeathID:0)  //utBuilder2
  );
