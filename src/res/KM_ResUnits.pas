...
const
  ...
  UNIT_OLD_ID_TO_TYPE: array[0..36] of TKMUnitType = (
    ...
    utWaterflower,utWaterleaf,utDuck, utRam, utGolem, utGiant, utOperator, utClayPicker); //Animals
...
begin
  ...
  begin
    ...
    if fUnitType >= utMilitia then
      Result := gResTexts[1770 + ord(fUnitType) - 16]
    else
...
begin
  ...
  fItems[utArcher].fUnitDat.HitPoints := 1;
