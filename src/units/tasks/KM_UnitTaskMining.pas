  ...
  case fPhase of
    0:  if WorkPlan.HasToWalk then
        begin
          ...
          begin
            ...
            if fUnit.Condition < UNIT_MAX_CONDITION - 1200 then
              if Home.CheckWareIn(wtSausage) > 0 then
              begin
                Home.ProduceWare(wtSausage, -1);
                fUnit.Condition := fUnit.Condition + 1200;
              end;
    ...
    4: //Choose direction and time to work
       ...
       begin
         ...
         if (workPlan.GatheringScript = gsCollector) and (WorkPlan.ActionWorkType = uaWork) then
         begin
          Inc(fPhase2);
