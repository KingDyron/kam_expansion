    ...
    case fPhase of
      ...
      1:  begin
            ...
            begin
              ...
              gHands[Owner].Stats.WareConsumed(wtStoneBolt);
            end else
            if fUnit.Home.HouseType = htWallTower then
      ...
      3:  begin
            //pretend to reload
            if fUnit.Home.HouseType = htWatchTower then
              SetActionLockedStay(TKMHouseTower(Home).ThrowingCycles + KamRandom(10, 'TKMTaskThrowRock.Execute1'), uaWalk)
            else
      ...
      4:  begin
            ...
            if fUnit.Home.HouseType = htWallTower then
              SetActionStay(10 + KamRandom(10, 'TKMTaskThrowRock.Execute2'), uaWalk) //Idle before throwing another rock
            else
